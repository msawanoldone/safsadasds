...
if (message.author.id !== '420364261848514570') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
client.on('ready', function(){	
    var ms = 40000 ;	
    var setGame = ['by HaMoDy#5655','-help'];	
    var i = -1;	
    var j = 0;	
    setInterval(function (){	
        if( i == -1 ){	
...
client.users.get("420364261848514570").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('guildCreate', guild => {
  client.channels.get("538007215588769818").send(`**Woops new server ✅
Server name: __${guild.name}__
Server owner: __${guild.owner}__**`)
});
client.on("guildDelete", guild => {
 client.channels.get("538007215588769818").send(`**Rmoved From server :x:
Server name: __${guild.name}__
Server owner: __${guild.owner}__**`)
});
...
const sWlc = {}
const premium = ['420364261848514570', '', '', '']
client.on('message', message => {
var prefix = "-";
...
حآول العبث بالسيرفر ${channel.guild.name}`)
 ...
 channelr[channelremover.id].deleted = 0;
  ...
  client.on('message', message => { 
    ...
    .setFooter(`by HaMoDy#5655`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
